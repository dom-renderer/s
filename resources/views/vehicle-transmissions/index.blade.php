...
<div class="welcome-box">
    <div class="welcome-left">
        <h1 class="h-30 clr-blue fw-bold">Vehicle Transmission Management</h1>
        <p class="mt-2">Manage vehicle transmissions and their details</p>
    </div>
    <div class="welcome-right">
        <a href="{{ route('vehicle-transmissions.create') }}" class="btn blue-btn d-flex gap-2">
            <img src="{{ asset('ui/images/+(1).svg') }}" alt="">
            Add New Vehicle Transmission
        </a>
    </div>
</div>
<div class="dash-md1">
    <div class="row">
        <div class="col-lg-4 col-md-6">
            <div class="status-box flx-manage mb-4">
                <div class="st-left">
                    <h3 class="h-14 mb-2">Total Transmissions</h3>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="status-box flx-manage mb-4">
                <div class="st-left">
                    <h3 class="h-14 mb-2">Active Transmissions</h3>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="status-box flx-manage mb-4">
                <div class="st-left">
                    <h3 class="h-14 mb-2">Inactive Transmissions</h3>
...
<div class="filter-box border-main padding-bx mb-4">
    <div class="flietr-left">
        <div class="search-filter">
            ...
            <input type="text" id="filter-name" class="form-control form-control-sm" placeholder="Search vehicle transmissions...">
        </div>
