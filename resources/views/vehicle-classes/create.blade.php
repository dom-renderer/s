...
<div class="welcome-box">
    <div class="welcome-left">
        <h1 class="h-30 clr-blue fw-bold">Add New Vehicle Class</h1>
        <p class="mt-2">Configure vehicle class details and status</p>
    </div>
</div>
<form id="vehicleClassForm" method="POST" action="{{ route('vehicle-classes.store') }}">
    @csrf
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Enter vehicle class title" required>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Enter vehicle class description">{{ old('description') }}</textarea>
    ...
    <div class="content-box">   
        <div class="save-draft">
            ...
            <div class="draft-rgt">
                ...
                <button type="submit" class="btn btn-gen bg-btn3">Create Vehicle Class</button>
            </div>
        </div>
    </div>
</form>
