...
<style>
    ...
    /* update setting css start */
    .section-title i {
        color: #00293e !important;
    }
    .btn.btn-outline-primary.bn-line {
        border: 1px solid #00293e;
        color: #00293e;
    }
    .btn.btn-outline-primary.bn-line:hover {
        background: #00293e;
    }
    .btn.btn-primary.mt-2.bg-mn {
        background: #00293e;
    }
    .btn.btn-primary.mn-oth {
        background: #00293e;
    }
    /* update setting css End */
</style>
@endpush
...
<div class="row justify-content-center">
    ...
    <div class="row mt-2">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="settings-section">
                        ...
                        <button type="button" class="btn btn-outline-primary bn-line" id="addLevel">
                ...
                <div class="card-body">
                    ...
                    <div class="department-select-container">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-primary mt-2 bg-mn" id="addInspectionDepartment">
        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary mn-oth">
            ...
            const templateString =  `
                <div class="escalation-level p-3" data-level="${level}">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button type="button" class="btn remove-level">
                            <img src="{{ url('settings-media/plus-sms.svg') }}" alt="" />
                        </button>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-12 col-xl-4">
                            <label class="form-label">Priority Level</label>
                            <select class="form-select priori ty-select" name="escalations[${level}][priority]">
