...
<div class="welcome-box">
    <div class="welcome-left">
        <h1 class="h-30 clr-blue fw-bold">Add New Location</h1>
        <p class="mt-2">Configure location details and coordinates</p>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" placeholder="Enter location code" required>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Enter location title" required>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('address_line_1') is-invalid @enderror" id="address_line_1" name="address_line_1" value="{{ old('address_line_1') }}" placeholder="Enter address line 1" required>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('address_line_2') is-invalid @enderror" id="address_line_2" name="address_line_2" value="{{ old('address_line_2') }}" placeholder="Enter address line 2">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select custom-select-arrow select2 @error('parish_id') is-invalid @enderror" id="parish_id" name="parish_id">
                            ...
                            @foreach($parishes as $id => $name)
                                <option value="{{ $id }}" {{ old('parish_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude') }}" placeholder="Latitude" readonly>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude') }}" placeholder="Longitude" readonly>
    ...
    <div class="content-box">   
        <div class="save-draft">
            ...
            <div class="draft-rgt">
                ...
                <button type="submit" class="btn btn-gen bg-btn3">Create Location</button>
            </div>
        </div>
    </div>
</form>
...
$(document).ready(function() {
    ...
    function initMap() {
        ...
        // If there are old values, set marker
        const oldLat = parseFloat($('#latitude').val());
        const oldLng = parseFloat($('#longitude').val());
        if (oldLat && oldLng) {
            const oldLocation = { lat: oldLat, lng: oldLng };
            map.setCenter(oldLocation);
            setMarker(oldLocation);
        }
    }
