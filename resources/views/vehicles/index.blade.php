...
<div class="welcome-box">
    <div class="welcome-left">
        <h1 class="h-30 clr-blue fw-bold">Vehicle Management</h1>
        <p class="mt-2">Manage vehicles and their details</p>
    </div>
    <div class="welcome-right">
        <a href="{{ route('vehicles.create') }}" class="btn blue-btn d-flex gap-2">
...
<div class="dash-md1">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="status-box flx-manage mb-4">
                <div class="st-left">
                    <h3 class="h-14 mb-2">Active Vehicles</h3>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="status-box flx-manage mb-4">
                <div class="st-left">
                    <h3 class="h-14 mb-2">Inactive Vehicles</h3>
...
<div class="filter-box border-main padding-bx mb-4">
    <div class="flietr-left">
        <div class="search-filter">
            ...
            <input type="text" id="filter-name" class="form-control form-control-sm" placeholder="Search vehicles...">
        </div>
