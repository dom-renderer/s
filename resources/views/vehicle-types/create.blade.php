...
<div class="welcome-box">
    <div class="welcome-left">
        <h1 class="h-30 clr-blue fw-bold">Add New Vehicle Type</h1>
        <p class="mt-2">Configure vehicle type details and status</p>
    </div>
</div>
<form id="vehicleTypeForm" method="POST" action="{{ route('vehicle-types.store') }}">
    @csrf
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Enter vehicle type title" required>
    ...
    <div class="content-box">   
        <div class="save-draft">
            ...
            <div class="draft-rgt">
                ...
                <button type="submit" class="btn btn-gen bg-btn3">Create Vehicle Type</button>
            </div>
        </div>
    </div>
</form>
